...
namespace CarpenterWorkshopRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IWoodBlankService, WoodBlankServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IWorkerService, WorkerServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IWoodCraftService, WoodCraftServiceBD>(new HierarchicalLifetimeManager());
