...
namespace CarpenterWorkshopView
{
    public partial class FormCreateOrder : Form
    {
        ...
        private readonly IWoodCraftService serviceWC;

        private readonly IMainService serviceM;

        public FormCreateOrder(ICustomerService serviceC, IWoodCraftService serviceP, IMainService serviceM)
        {
            InitializeComponent();
        ...
        private void FormCreateOrder_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                List<WoodCraftViewModel> listP = serviceWC.GetList();
                if (listP != null)
                {
        ...
        private void CalcSum()
        {
            if (comboBoxProduct.SelectedValue != null && !string.IsNullOrEmpty(textBoxCount.Text))
            {
                try
                {
                    ...
                    WoodCraftViewModel product = serviceWC.GetElement(id);
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                serviceM.CreateOrder(new OrdProductBindingModel
                {
